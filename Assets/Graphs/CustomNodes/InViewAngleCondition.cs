...
[Condition(name: "In view angle", story: "If angle between [self] and [target] [operator] [threshold]", category: "Conditions", id: "1579321f13324c849574f5bff137ccae")]
public partial class InViewAngleCondition : Condition
{
    ...
    public override bool IsTrue()
    {
        ...
        var angle = Vector3.Angle(Self.Value.forward, Target.Value.position);
        Debug.Log($"{angle}");
